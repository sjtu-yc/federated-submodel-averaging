...
class Model(object):
    def __init__(self, n_uid, n_mid, EMBEDDING_DIM, opt_alg='sgd'):
        ...
        self.item_eb = tf.concat([self.mid_batch_embedded], 1)     # [B, 2*H]
        self.item_his_eb = tf.concat([self.mid_his_batch_embedded], 2)     # [B, L, 2*H]
...
class Model_DIN(Model):
    def __init__(self, n_uid, n_mid, EMBEDDING_DIM, opt_alg='sgd'):
        super(Model_DIN, self).__init__(n_uid, n_mid, EMBEDDING_DIM, opt_alg)
